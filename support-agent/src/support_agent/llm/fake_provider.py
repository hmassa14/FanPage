...
class FakeProvider:
    ...
    def research(
        ...
        brief = ResearchBrief(
            ...
            order_total_usd=float(orders[0]["total_usd"]) if orders else None,
    ...
    def draft(
        ...
        draft = DraftReply(
            ...
            declines_request=res.startswith(
                ("Item is Final Sale", "More than 60 days", "Order already shipped", "31-60 days")
            ),
            confidence=confidence,
